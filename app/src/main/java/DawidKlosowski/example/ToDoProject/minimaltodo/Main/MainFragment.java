...
import DawidKlosowski.example.ToDoProject.minimaltodo.About.AboutActivity;
import DawidKlosowski.example.ToDoProject.minimaltodo.AddToDo.AddToDoActivity;
import DawidKlosowski.example.ToDoProject.minimaltodo.AddToDo.AddToDoFragment;
import DawidKlosowski.example.ToDoProject.minimaltodo.Analytics.AnalyticsApplication;
import DawidKlosowski.example.ToDoProject.minimaltodo.AppDefault.AppDefaultFragment;
import com.example.Project.minimaltodo.R;
import DawidKlosowski.example.ToDoProject.minimaltodo.Reminder.ReminderFragment;
import DawidKlosowski.example.ToDoProject.minimaltodo.Settings.SettingsActivity;
import DawidKlosowski.example.ToDoProject.minimaltodo.Utility.ItemTouchHelperClass;
import DawidKlosowski.example.ToDoProject.minimaltodo.Utility.RecyclerViewEmptySupport;
import DawidKlosowski.example.ToDoProject.minimaltodo.Utility.StoreRetrieveData;
import DawidKlosowski.example.ToDoProject.minimaltodo.Utility.ToDoItem;
import DawidKlosowski.example.ToDoProject.minimaltodo.Utility.TodoNotificationService;
...
public class MainFragment extends AppDefaultFragment {
    ...
    public static final String TODOITEM = "todo.MainActivity";
    ...
    public void onResume() {
        ...
        we mark our recreate_activity key as true. The recreate_key's value is changed to false before calling recreate(), or we woudl have ended up in an infinite loop,
    ...
    private void deleteAlarm(Intent i, int requestCode) {
        if (doesPendingIntentExist(i, requestCode)) {
            ...
            Log.d("Walter", "PI Cancelled " + doesPendingIntentExist(i, requestCode));
        }
    }
